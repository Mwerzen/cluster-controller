...
class KafkaAdapter implements MessagePoller, SlaveMessenger {
	...
	private KafkaAdapter() {
		...
		consumerProps.put("value.deserializer", "com.mikewerzen.servers.cluster.lifecycle.messaging.KafkaJSONAdapter");
		...
		producerProps.put("value.serializer", "com.mikewerzen.servers.cluster.lifecycle.messaging.KafkaJSONAdapter");
